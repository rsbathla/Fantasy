...
---
## 2026 roster adjustments (added)
Offense mover usage is re-projected onto 2026 teams (`reproject_movers.py`, provenance `usage_src`/`mover_conf`, raw under `*_25raw`); defense is roster-reweighted + bridged to the boom side. Full detail: **ROSTER_ADJUSTMENTS_2026.md**.
