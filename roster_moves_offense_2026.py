...
MOVES = {
 ...
 'jmari taylor':{'from':None,'to':'JAX','conf':'high','src':'https://www.jaguars.com/team/players-roster/j-mari-taylor/','provenance':['dk', 'ffdataroma', 'signals', 'features', 'flags'],'note':'ROOKIE (Virginia 2025) -> JAX UDFA 2026-04-26. from corrected IND->None on 2026-07-05: the IND origin was a first-initial collision with Jonathan Taylor; this rookie was never on IND, so no IND volume is vacated.'},
 ...
 'kevin coleman':{'from':None,'to':'MIA','conf':'high','src':'https://www.miamidolphins.com/team/players-roster/kevin-coleman-jr/','provenance':['dk', 'ffdataroma', 'clay', 'signals', 'features', 'flags'],'note':'ROOKIE (Missouri 2025) -> MIA R5 pick 177 2026-04-25. from corrected BUF->None on 2026-07-05: the BUF origin was a first-initial collision with Keon Coleman; this rookie was never on BUF, so no BUF volume is vacated.'},
